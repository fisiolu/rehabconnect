...
export interface Fisioterapista {
  ...
  valutazione: number;
  /**
   * Iscrizione all'Ordine dei Fisioterapisti (OFI territoriale, federati in FNOFI).
   * Va verificata su fisionet.fnofi.it prima di pubblicare un profilo.
   */
  numeroAlbo: string;
  /**
   ...
   */
  tariffa: { min: number; max: number };
  /** Assicurazioni e fondi sanitari con cui il professionista lavora. Può essere vuoto. */
...
export const fisioterapisti: Fisioterapista[] = [
  // ---- Milano e hinterland ----
  {
    ...
    email: "anna.ferrari@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.8,
    numeroAlbo: "OFI Milano n. 1847",
    tariffa: { min: 50, max: 70 },
    assicurazioni: ["UniSalute", "Previmedical"],
  ...
  },
  {
    ...
    email: "luca.esposito@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.6,
    numeroAlbo: "OFI Milano n. 2103",
    tariffa: { min: 45, max: 65 },
  ...
  },
  {
    ...
    email: "sara.romano@fisioterapia.demo",
    disponibile: false,
    valutazione: 4.9,
    numeroAlbo: "OFI Milano n. 1592",
    tariffa: { min: 55, max: 75 },
    assicurazioni: ["Previmedical", "Metasalute"],
  ...
  },
  {
    ...
    email: "marco.colombo@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.4,
    numeroAlbo: "OFI Milano n. 2571",
    tariffa: { min: 45, max: 60 },
    assicurazioni: [],
  ...
  // ---- Lazio meridionale (golfo di Gaeta) ----
  {
    ...
    email: "giulia.desantis@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.9,
    numeroAlbo: "OFI Latina n. 0784",
    tariffa: { min: 40, max: 55 },
    assicurazioni: ["UniSalute", "Generali", "Previmedical"],
  ...
  },
  {
    ...
    email: "antonio.parisi@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.7,
    numeroAlbo: "OFI Latina n. 0912",
    tariffa: { min: 45, max: 60 },
    assicurazioni: ["Previmedical"],
  ...
  },
  {
    ...
    email: "valentina.iannone@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.8,
    numeroAlbo: "OFI Latina n. 1055",
    tariffa: { min: 50, max: 65 },
    assicurazioni: ["UniSalute", "Metasalute"],
  ...
  },
  {
    ...
    email: "roberto.fusco@fisioterapia.demo",
    disponibile: false,
    valutazione: 4.5,
    numeroAlbo: "OFI Latina n. 0641",
    tariffa: { min: 50, max: 70 },
  ...
  // ---- Roma ----
  {
    ...
    email: "chiara.bruno@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.7,
    numeroAlbo: "OFI Roma n. 3312",
    tariffa: { min: 55, max: 75 },
    assicurazioni: ["UniSalute", "Previmedical", "Fasdac"],
  ...
  },
  {
    ...
    email: "davide.neri@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.3,
    numeroAlbo: "OFI Roma n. 4108",
    tariffa: { min: 50, max: 70 },
    assicurazioni: [],
  ...
  },
  {
    ...
    email: "elena.ricci@fisioterapia.demo",
    disponibile: true,
    valutazione: 5,
    numeroAlbo: "OFI Roma n. 2876",
    tariffa: { min: 60, max: 80 },
    assicurazioni: ["UniSalute", "Allianz"],
  ...
  // ---- Campania ----
  {
    ...
    email: "salvatore.amato@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.6,
    numeroAlbo: "OFI Napoli n. 1934",
    tariffa: { min: 40, max: 55 },
    assicurazioni: ["Previmedical"],
  ...
  },
  {
    ...
    email: "rosa.delprete@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.8,
    numeroAlbo: "OFI Caserta n. 0827",
    tariffa: { min: 45, max: 60 },
    assicurazioni: ["UniSalute", "Metasalute"],
  ...
  // ---- Resto d'Italia ----
  {
    ...
    email: "federico.gallo@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.5,
    numeroAlbo: "OFI Torino n. 1466",
    tariffa: { min: 50, max: 70 },
    assicurazioni: ["Generali", "Previmedical"],
  ...
  },
  {
    ...
    email: "martina.conti@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.9,
    numeroAlbo: "OFI Bologna n. 0993",
    tariffa: { min: 55, max: 75 },
    assicurazioni: ["UniSalute", "Previmedical"],
  ...
  },
  {
    ...
    email: "alessandro.fabbri@fisioterapia.demo",
    disponibile: false,
    valutazione: 4.4,
    numeroAlbo: "OFI Firenze n. 1201",
    tariffa: { min: 55, max: 70 },
  ...
  },
  {
    ...
    email: "nicola.lorusso@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.6,
    numeroAlbo: "OFI Bari n. 0715",
    tariffa: { min: 40, max: 55 },
    assicurazioni: ["UniSalute"],
  ...
  },
  {
    ...
    email: "grazia.randazzo@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.7,
    numeroAlbo: "OFI Palermo n. 1338",
    tariffa: { min: 40, max: 55 },
    assicurazioni: ["Previmedical", "Metasalute"],
  ...
  },
  {
    ...
    email: "paolo.marras@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.5,
    numeroAlbo: "OFI Cagliari n. 0562",
    tariffa: { min: 45, max: 60 },
    assicurazioni: [],
  ...
  },
  {
    ...
    email: "silvia.zanetti@fisioterapia.demo",
    disponibile: true,
    valutazione: 4.8,
    numeroAlbo: "OFI Verona n. 0847",
    tariffa: { min: 50, max: 70 },
    assicurazioni: ["UniSalute", "Generali"],
